...
const tools = [
  ...
  ["proposeCreativeCutout", "creative.propose_cutout", "propose_athlete_cutout", "propose_cutout"],
  ...
  ["applyCreativeCutout", "creative.apply_cutout", "apply_athlete_cutout", "apply_cutout_candidate"],
